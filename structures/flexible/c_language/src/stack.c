...
Stack *new_stack() {
  ...
  if (new != null) {
    ...
    printf("Erro(new_stack): nao foi possivel criar pilha.\n");
}
...
void free_stack(Stack *stack) {
  if (stack->top != null) {
    ...
    printf("Erro(free_stack): pilha vazia.\n");
}
...
void print_stack(Stack *stack) {
  if (stack->top != null) {
    ...
    printf("Erro(print_stack): pilha vazia.\n");
}
...
void push(Stack *stack, int x) {
  ...
  if (stack && new != null) {
    ...
    printf("Erro(push): nao foi possivel criar nova celula na pilha.\n");
}
