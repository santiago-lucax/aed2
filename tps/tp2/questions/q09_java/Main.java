...
public class Main {
    ...
    /*
     * função auxiliar de comparação para o heapsort
     * encapsula a lógica de data e desempate por nome
     * retorna positivo se r1 > r2, negativo se r1 < r2, e 0 se iguais
    */
    public static int comparar(Restaurante r1, Restaurante r2) {
        comparacoes++;
        // converter datas para um valor inteiro no formato YYYYMMDD facilita a comparação
        int val1 = r1.getDataAbertura().getAno() * 10000 + r1.getDataAbertura().getMes() * 100 + r1.getDataAbertura().getDia();
        int val2 = r2.getDataAbertura().getAno() * 10000 + r2.getDataAbertura().getMes() * 100 + r2.getDataAbertura().getDia();

        if (val1 != val2) {
            return Integer.compare(val1, val2);
        }
        
        comparacoes++; // caso as datas sejam iguais, contabiliza o desempate
        return r1.getNome().compareTo(r2.getNome());
    }

    /*
     * algoritmo de ordenação heapsort
     * ordena o arranjo pelo atributo data_abertura (desempate: nome)
    */
    public static void heapsort(Restaurante[] arr, int n) {
        // construir o max-heap (rearranjar o array)
    ...
    /*
     * método para manter a propriedade do max-heap
    */
    public static void heapify(Restaurante[] arr, int n, int i) {
    ...
    */
    public static void main(String[] args) {
        ...
        try {
            PrintWriter log = new PrintWriter(new File("897498_heapsort.txt"));
